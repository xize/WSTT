...
func setTrustedPolicy()
   MouseClick("primary", 380, 200, 2, 1)
   WinWait("Eigenschappen van Vertrouwde uitgevers")
   MouseClick("primary", 260, 160, 1, 1)
   MouseClick("primary", 260, 260, 1, 1)
   MouseClick("primary", 260, 363, 1, 1)
   pressOK()
EndFunc
...
MouseClick("primary", 48, 207, 1, 1)
sleep(500)
MouseClick("right", 45, 207, 1, 1)
Sleep(500)
MouseClick("primary", 48, 212, 1, 1)
Sleep(500)
Send("{ENTER}")
Sleep(500)
