...
namespace windows_security_tweak_tool.src.controls
{
    public partial class SecurityControl_DARK : UserControl
    {
        ...
        private void securityControl_LIGHT2_Load(object sender, EventArgs e)
        {

        }

        private void securityControl_LIGHT1_Load(object sender, EventArgs e)
        {
